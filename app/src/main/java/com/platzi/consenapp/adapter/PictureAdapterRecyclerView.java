package com.platzi.consenapp.adapter;
...
import com.platzi.consenapp.view.PictureDetailActivity;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class PictureAdapterRecyclerView extends RecyclerView.Adapter
        <PictureAdapterRecyclerView.PictureViewHolder> {
    ...
    public PictureViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        /*Instatiate the class PICTURE
        * inflates the view the card view
        * */
